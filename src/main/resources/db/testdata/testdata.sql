...
VALUES ('Wszystkie kategorie'),
       ...
       ('Nieruchomości');
INSERT INTO PROMO
    (name, description, price, url_address, category_id, user_id)
VALUES
...
soowoinia nawei naiciezsze zacania', 5899, 'https://www.x-kom.pl/p/606361-notebook-laptop-133-apple-macbook-air-m1-16gb-256-mac-os-silver.html',2, 1),
...
ultraprzenośny, superwszechstronny laptop do pracy, zabawy i tworzenia wszystkiego, czego ', 5899, 'https://www.x-kom.pl/p/1054824-notebook-laptop-133-apple-macbook-air-m2-16gb-256-mac-os-silver.html',2, 2),
...
Lampa oferuje kompatybilność z Razer Chroma, dzięki czemu możesz cieszyć się wciągającą rozgrywką i doskonałą imersją.' ||
     ...
     299,'https://www.x-kom.pl/p/721440-inteligentna-lampa-yeelight-lampa-na-monitor-screen-light-bar-pro-rgb.html', 2, 3),
    ...
    ('Czapka męska z daszkiem 4F Bejsbolówka 2023 L',
     ...
     44.90, 'https://allegro.pl/oferta/czapka-meska-z-daszkiem-4f-bejsbolowka-2023-l-13492195285?bi_s=ads&bi_m=productlisting:desktop:query&bi_c=NTUwOGI0ZjItMWQ3OS00ZThlLWI0MGEtMjEzY2ZmMWU2MTFlAA&bi_t=ape&referrer=proxy&emission_unit_id=7b25b5b9-54d8-4b86-a74f-65afd3a46524',3, 2),
    ...
    ('Tabliczka Tablica ADRESOWA ALUMINIOWA - Numer domu',
     ...
     'Grafika w wysokiej jakości i rewelacyjnej cenie.', 40,'https://allegro.pl/oferta/tablica-tabliczka-adresowa-numer-domu-aluminiowa-11356934049?bi_s=ads&bi_m=productlisting:desktop:query&bi_c=NDk3ODAxZjgtNzc5YS00MTNjLWJhZDItMzBlNjJkMDczZDc3AA&bi_t=ape&referrer=proxy&emission_unit_id=eae55830-0019-4cb0-a2c2-a69b720f48ec', 4, 2),
    ...
    ('Kawa cappuccino Jacobs',
     ...
     11.90,'https://allegro.pl/oferta/kawa-rozpuszczalna-jacobs-cappuccino-caramel-10790745595?bi_s=ads&bi_m=productlisting:desktop:query&bi_c=NDU0NjNiMGItMGUwMS00MWIyLWJiNmMtN2ViNWEzZWU2ZmE5AA&bi_t=ape&referrer=proxy&emission_unit_id=d00e0c7d-fbee-4f5d-91c5-b6612b12a280', 5, 1);
